        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-2 xl:gap-3 shrink-0 pl-2">
            ...
            <a
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] xl:text-xs font-bold text-[#EADBC8] bg-[#FAF8F5]/10 border border-[#EADBC8]/30 rounded-xl hover:bg-[#FAF8F5]/20 transition-all shrink-0 whitespace-nowrap"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-1.5 text-[11px] xl:text-xs font-black uppercase text-[#1B3B2B] bg-[#EADBC8] hover:bg-[#F3E8D8] rounded-xl shadow-md transition-all shrink-0 whitespace-nowrap cursor-pointer"
            >
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-[#1B3B2B] border-b border-[#2D5A3F] px-4 pt-3 pb-6 space-y-4 shadow-2xl animate-in slide-in-from-top duration-200">
          ...
          <div className="border-t border-[#8FAF96]/30 pt-3 space-y-3">
            ...
            <a
              href="tel:+48535914149"
              className="flex items-center justify-center gap-2.5 w-full py-3.5 px-4 text-sm font-bold text-[#EADBC8] bg-[#FAF8F5]/10 border border-[#EADBC8]/40 rounded-xl hover:bg-[#FAF8F5]/20 transition-all shadow-sm"
            >
