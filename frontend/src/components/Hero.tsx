...
import { Phone, Calendar, ShieldCheck, Clock, Zap, MapPin } from 'lucide-react';
...
export const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="relative pt-24 pb-12 sm:pt-28 sm:pb-16 bg-[#FAF8F5] text-[#14261C] overflow-hidden">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                ...
                <a
                  ...
                  className="px-6 py-4 bg-[#FAF8F5]/10 border border-[#EADBC8]/30 hover:bg-[#FAF8F5]/20 rounded-xl text-white font-bold text-sm flex items-center justify-center gap-2.5 transition-all"
                >
            ...
            <div className="p-4 rounded-2xl bg-[#1B3B2B] border border-[#8FAF96]/30 flex items-center justify-between gap-3">
              <div>
                ...
                <p className="text-[11px] text-gray-200">
                  {language === 'pl' ? 'Szybka rezerwacja telefoniczna' : 'Quick phone dispatch'}
                </p>
              </div>
              <a
                href="tel:+48535914149"
