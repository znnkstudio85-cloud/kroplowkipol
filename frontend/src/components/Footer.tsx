      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-4 space-y-4">
            <h4 className="text-xs font-black uppercase tracking-wider text-[#EADBC8] italic">
              {language === 'pl' ? 'Infolinia & Social Media' : 'Direct Line & Socials'}
            </h4>
            <div className="space-y-2 text-xs">
              <p className="flex items-center gap-2 font-black text-white">
                <Phone className="w-3.5 h-3.5 text-[#EADBC8]" />
                <a href="tel:+48535914149" className="hover:text-[#EADBC8] transition-colors">+48 535 914 149</a>
              </p>
              ...
              <p className="flex items-center gap-2 text-gray-300">
                <MapPin className="w-3.5 h-3.5 text-[#EADBC8]" />
            ...
            <div className="flex flex-wrap items-center gap-2 pt-1">
              <a
                ...
                className="px-3 py-1.5 rounded-lg bg-[#2D5A3F]/80 border border-[#8FAF96]/30 text-white hover:bg-[#2D5A3F] transition-colors text-[11px] font-bold flex items-center gap-1.5"
              >
                <span>Instagram</span>
              </a>
              <a
